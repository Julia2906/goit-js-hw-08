...
const createGalleryCardTamplate = (image) => `
  <li class="gallery-item">
    <a class="gallery-link prevent-download" href="${image.original}">
    <img
      class="gallery-image"
      src="${image.preview}"
...
const galleryCardTamplate = images
  .map((el) => createGalleryCardTamplate(el))
  .join("");

const galleryListEl = document.querySelector(".gallery");

galleryListEl.innerHTML = galleryCardTamplate;

document.querySelectorAll(".prevent-download").forEach((link) => {
